...
public class TestParser {
  ...
  @Test(expected = Json.MalformedJsonException.class)
  public void malformedTest6() {
    Json.read("[true, false, ]");
  }

  @Test(expected = Json.MalformedJsonException.class)
  public void malformedTest7() {
    Json.read("[true, 10, \"asdf\"");
  }

  @Test(expected = Json.MalformedJsonException.class)
  public void malformedTest8() {
    Json.read("{[}");
  }

  @Test(expected = Json.MalformedJsonException.class)
  public void malformedTest9() {
    Json.read("{\"a\":[}");
  }

  @Test(expected = Json.MalformedJsonException.class)
  public void malformedTest10() {
    Json.read("[{]");
  }
  ...
  public void parseObjects() {
    ...
    Assert.assertEquals(Json.object("one", 1, "maybe", false, "nothing", null), Json.read("\t{\"one\":1, \t    \"maybe\":false , \n\n\"nothing\"    :     null} "));
  }
