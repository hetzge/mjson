...
public class TestWithOptions {
  ...
  public void testObjectMerge() {
    Json o1 = object("id", 2, "name", "John", "address", object("streetName", "Main", "streetNumber", 20, "city", "Detroit"));
  ...
  public void testUnsortedArrayMerge() {
    ...
    Assert.assertEquals(TU.set(a1.asJsonList()), TU.set(array(4, 35, 1, 65, 2, 456, 65, 5, 3534, 4).asJsonList()));
  }
